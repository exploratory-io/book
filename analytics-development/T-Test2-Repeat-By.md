...
<% if (p <= 0.05) { %>
以下のグループにおいては、P値が有意水準5% (0.05) より低いため、統計的に有意だと言えます。
* <group_name>

<% } else { %>
以下のグループにおいては、P値が有意水準5% (0.05) より高いため、統計的に有意とは言えません。
* <group_name>
<% } %>
...
もし帰無仮説が正しいのであれば、今回のデータに見られる差かそれ以上の差がたまたま起きる確率がP値です。もし有意水準である5% (0.05）より大きければ、帰無仮説を棄却できないため、統計的に有意だとは言えません。逆に、5% (0.05）以下であれば、帰無仮説を棄却できるため、統計的に有意だと言えます。
...
一般的なガイダンスとして、0.8よりも大きければ大きな差、0.2から0.8の間であれば中程度の差、0.2よりも小さければ小さな差であると考えられます。
