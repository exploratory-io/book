...
因子得点の正負の解釈は、因子負荷量の符号によって変わります。

* 因子負荷量がプラスの変数は、因子得点が高いほどその変数の値も高くなり、因子得点が低いほどその変数の値も低くなります。
* 一方、因子負荷量がマイナスの変数は、因子得点が高いほどその変数の値は低くなり、因子得点が低いほどその変数の値は高くなります。

具体的な解釈をする際は、「因子と変数の関係」の表で因子負荷量の符号を確認してください。
