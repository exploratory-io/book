...
シルエット法は、各データポイントが自分のクラスターに対してどれだけうまく適合しているかを、隣接するクラスターと比較して評価します。シルエットスコアが高いほど、クラスターの分離がよいことを示します。平均シルエットスコアがピークとなるクラスター数が最適な数の目安となります。
...
K-Means クラスタリングで「最適なクラスター数（K）」を選ぶための視覚的な手法の1つとしてエルボー法が使えます。
