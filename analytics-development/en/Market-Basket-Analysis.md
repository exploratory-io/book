...
*   The thickness of the line represents the "frequency of that combination (support)", and a thicker line means a combination with a higher frequency (probability).
