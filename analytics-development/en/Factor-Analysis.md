...
* For variables with positive factor loadings, higher factor scores correspond to higher variable values, and lower factor scores correspond to lower variable values.
