...
Exploratoryデスクトップでは、AIを活用してデータ加工や分析を効率化する各種機能を提供しています。これらの機能を利用する際、お客様のデータの一部がAIサービスプロバイダーに送信されます。

送信されるデータの内容は、利用する機能によって以下の通りとなります。

| **利用する機能**    | **AIサービスプロバイダー** | **送信される主な内容**                                       |
| ------------------- | -------------------------- | :----------------------------------------------------------- |
| AI データ加工       | Anthropic (Claude)         | プロンプト、列名、データ型、（設定により）サンプルデータ     |
| AI 関数             | Google (Gemini)            | プロンプト、列名、データ型、指定した列の値                   |
| AI サマリ           | Google (Gemini)            | チャートやアナリティクスビューで生成されたチャートの集計済みデータ |
| AI ノートエディター | Google (Gemini)            | プロンプト、ノート内テキスト、ノート内に追加されたチャートの集計済みデータ |

### AI機能の無効化

AI機能はシステムレベルで一括して無効化することができます。システム設定のAIタブにある「AI機能を使う」のチェックを外すことで、AIデータ加工、AI関数、AIサマリ、AIノートエディターなど、アプリ全体のAI関連機能をまとめて無効にでき、外部AIサービスへのデータ送信を防ぐことができます。

詳細な設定方法については、[こちら](https://community-ja.exploratory.io/t/topic/2112)をご参照ください。

### 「AIデータ加工」利用時のサンプルデータ制御

「AIデータ加工（データラングリング with AIプロンプト）」機能では、提案の精度を調整するために、送信するデータの範囲をお客様自身で設定いただけます。
...
詳細な設定方法については、[こちら](https://community-ja.exploratory.io/t/topic/2114)をご参照ください。

### データプライバシーと安全性の確保

Exploratoryでは、お客様のデータを保護するために以下のポリシーを徹底しています。

1. **データの保存について：**

   どのAI機能を利用した場合でも、お客様のデータやプロンプトの内容が**Exploratoryのサーバーに保存・保持されることは一切ありません。** 情報はプロンプトの一部としてAIサービスへ直接送信され、処理が行われます。
