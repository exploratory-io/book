...
Once you publish your data, you can setup a schedule to refresh your data periodically. See the [document](../schedule/manage.md) for more details about how to manage the schedule. 