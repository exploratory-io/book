...
This makes the chart always taking the data from the 'pinned' step regardless which step you click.
...
This time all the circles inside New York City are colored as 'TRUE' color - blue.
