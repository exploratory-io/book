...
* AI: データラングリングで「AI 関数」機能が追加され、ステップ内でAIプロンプト・テンプレートを選択できるようになりました。
* AI: ノートで「AIエディター」機能が追加され、AIプロンプト・テンプレートを選択できるようになりました。
...
* パブリッシュ: サーバー: 「AI 関数」および「AI エディター」の検索タイプが追加されました。


### 修正された問題

* AI プロンプト: オフライン時に「AI データ加工」ボタンが表示されないという問題を修正しました。
* AI プロンプト: スピンアイコンが表示されたままになるという問題を修正しました。
...
* チャート: 基準線: Y軸に移動平均、X軸とY軸に特定の値の基準線を追加するとエラーが発生するという問題を修正しました。
...
* アナリティクス: 決定木: 目的変数に論理値型の列を割り当てたとき、ノードの値が 0.5 の背景がニュートラルにならない問題を修正しました。
...
* ノート: ワードクラウドチャートが編集モードで壊れたアイコンとして表示されるという問題を修正しました。


* ダッシュボード: パブリッシュ通知メールのサムネイルにホバーポップアップが表示されるという問題を修正しました。
* ダッシュボード: 「全ページに適用」をオフにしても、Rコードブロックがないページでパラメーター更新時にページ全体がリフレッシュされるという問題を修正しました。
