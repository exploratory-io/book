...
* [Data Import](data_import.md)
   ...
   * [Database Data](database-data.md)
      ...
      * [Oracle (OCI)](import/oracle-oci.md)
...
* [Analytics](analytics.md)
   ...
   * [K-Modes Clustering](analytics/kmodes.md)
   ...
   * [Ordered Logistic Regression Analysis](analytics/ordered_logistic_regression.md)
   ...
   * [Cronbach's Alpha](analytics/cronbach-alpha.md)
