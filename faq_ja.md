...
macOS Big Surについては、基本操作をテストし、問題なく動作することを確認しております。macOS Big SurでExploratoryを新規インストールする際に、Rのインストールに関して既知の問題が報告されております。こちらの[コミュニティサイト](https://community.exploratory.io/t/r-installation-error-on-macos-big-sur/1948)をご確認ください。
