...
## D. Exploratoryによるアカウントの停止または終了

Exploratoryは独自の裁量で、いつでも何らかの理由で誰にでもサービスを拒否する権利を保有し、お客様のアカウントを一時停止または終了する権利を有し、製品およびサービス、またはその他のExploratoryサービスの現在および将来の使用をすべて拒否することができます。このようなサービスの終了は、お客様のアカウントの無効化または削除、お客様のアカウントへのアクセス、お客様のアカウント内のすべてのコンテンツの没収および放棄につながります。

Exploratoryがアカウントの停止または終了の措置を講じる場合には、違法行為のためにアカウントが即時停止または終了されない限り、お客様のリクエストに応じ、お客様所有のコンテンツのコピーを提供するよう妥当な努力をいたします。

また、アカウントを停止または終了したさいには、その時点で既にお支払いいただいた額に対してまだ未使用となる期間の残額は返金されます。

ちなみに、現時点（2024年10月17日）において、2016年5月サービス開始以降、有料アカウントを無効化したことはありませんが、無料アカウント（トライアル期間中、パブリック板）につき、スパムまたはイタズラと思われるアカウント作成に関しては、アカウントを削除させてただいたことがあります。

アカウントを停止または終了させていただくケースとしては、以下の通りとなります。

* Exploratory、またはその他のExploratoryのサービスに関連していることを間違って暗示するように、サービスの修正、改造、または改ざん。
* Exploratoryの明示的な書面による許可なく、製品およびサービスの一部、サービスの使用、またはサービスへのアクセスを複製、複写、複製、販売、転売または転用。
* 違法、不快、脅迫、誹謗中傷、名誉毀損、ポルノ、猥褻またはその他の不快なものであるか、または当事者の知的財産またはこれらの利用規約に違反する可能性があるコンテンツの公開。
* Exploratoryの顧客、従業員、メンバーまたは役員に対する口頭、物理的、書面またはその他のかたちでの虐待（虐待または報復の脅威を含む）のあった場合。
* 迷惑メール、迷惑SMS、「スパム」メッセージ、ウイルス、または破壊的な性質のコードをアップロード、投稿、ホスト、送信。
* 反社勢力の方によるアカウント。

こうした問題が発見された際には、違法行為のためにアカウントが即時停止または終了されない限り、問題事項を当該アカウント所有者に事前に連絡させていただき、問題でない場合はそのことの説明または証明、または問題事項の改善がないようであれば実際に停止、または終了させていただくこととなります。

こちらに関しては個別契約（特約）の締結の対応は可能ですので、その際はサポート（support@exploratory.io）までご連絡下さい。
...
Exploratoryのサポートは、購読しているプラ​​ンに応じて、コミュニティ、電子メール、または電話で英語と日本語でのみ利用できます。

お客様は、Exploratoryがサードパーティベンダおよびホスティングパートナーを使用して、本サービスの実行に必要なハードウェア、ソフトウェア、ネットワーク、ストレージ、および関連技術を提供することをご理解の上で本サービスを使用いただくようお願い致します。
...
Exploratoryの顧客、従業員、メンバーまたは役員に対する口頭、物理的、書面またはその他のかたちでの虐待（虐待または報復の脅威を含む）のあった場合は、即座にアカウントを終了させていただきます。

迷惑メール、SMS、「スパム」メッセージ、ウイルス、または破壊的な性質のコードをアップロード、投稿、ホスト、送信することはできません。

お客様の帯域幅の使用量がExploratoryの他のお客様の平均帯域幅使用量（Exploratoryによってのみ決定されたもの）を大幅に上回る場合、お客様が帯域幅消費を減らすまで、お客様の使用を一時保留とさせていただくことがあります。

当社はExploratoryの、（i）サービスがお客様の特定の要件を満たしていること、（ii）サービスが中断なく、タイムリーに、安全に、またはエラーフリーであること、（iii）サービスの使用により得られる結果が正しく信用できる、 （iv）サービスを通じてお客様が購入または取得した製品、サービス、情報、またはその他の素材の品質がお客様の期待を満たしていること、および（v）サービスの全てのエラーが修正されること、を保証しません。

当社はExploratoryのソフトウェアによる機会、利益、使用、データ、または他の無形の損失を含む、直接的、間接的、偶発的、特殊的、必然的または典型的な損害について責任を負いません。例として、
